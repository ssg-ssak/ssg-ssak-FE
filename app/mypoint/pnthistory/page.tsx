  ...
  return (
    <section className='pt-[106px]'>
      ...
      <div className='point_info_cardbox  p-6 bg-white '>
        <div className='cardbox bg-linear_93 overflow-hidden rounded-3xl h-full pb-[2px] shadow-md max-w-sm my-0'>
          <div className='top_cnt flex items-center relative h-[40px] pr-[12px] pl-[20px] justify-between'>
            <h3 className='tit_img bg-[url("/images/cardSinsegaeLogo.png")] w-[113px] h-[20px] bg-cover indent-[-999rem] mt-[1px]'>SHINSEGAE POINT</h3>
            <button className='btn_info w-4 h-4 bg-[url("/images/cardInfoLogo.png")] bg-cover'>
      ...
      <div className='collect_receipts_banner bg-[#fcebf1] h-[65px] relative'>
        <div className={`in_box pt-[12px] pl-[55px] my-0 mx-6 ${receiptsEventLogo} `}>
