...
function page() {
  return (
    <section className='pt-[56px]'>
      ...
      <CertForm types={"/member/findpwresult"}/>
      ...
      <div className='mt-10 relative py-5 px-7 border-[#e8e8e8] border-[1px] mx-5 mb-20 shadow-md rounded-lg'>
        <p className='text-[13px] leading-5 text-[#767676]'>
          <strong className='text-[14px] leading-6 text-black'>아이디가 생각나지 않으세요?</strong>
          <br/>
          본인인증 후 비밀번호를 변경하실 수 있습니다. 
        </p>
        <Link className='mt-4 inline-flex items-center text-[14px]' href={"/member/findidpw"}>아이디 찾기 {">"}</Link>
      </div>
    </section>
  )
}
