  ...
  <div className='mt-40 font-sans'>
    ...
    <div className='px-[24px] py-[20px] mx-[20px] border rounded-[8px] shadow-[0_3px_8px_rgba(0,0,0,.08)]'>
      ...
      <div className='px-[20px] py-[40px]'>
        ...
        <input className='w-[22px] h-[22px] appearance-none border rounded-full border-black'
        id ="checkbox1"
        type ="checkbox" />
        <span className='text-[11px] pl-[1px] absolute'>[선택]혜택제공 및 분석을 위한 개인정보 제공 및 이용 동의</span>
        </label>
        </div>
        <div>
        <label className='pt-[1px]'>
