  ...
  return (
    <footer className='bg-white border'>
      <div className='p-6'>
        ...
        <div className='text-[11px] mr-[9px] text-slate-600 mb p-[3px] leading-5'>
          <p className='pb-1'>
            <span className='block'>㈜이마트 서울시 중구 세종대로 7길 37(순화동)</span>
            <span className='inline-block align-top mr-[9px]'>대표자 : 강희석</span>
            <span className='inline-block align-top'>사업자등록번호 : 206-86-50913</span>
          </p>
          <p className='text-[10px]'>COPYRIGHT (c) EMART INC. ALL RIGHTS RESERVED.</p>
        </div>
        
        <div className='absolute bottom-5 right-4'>
          <a href="http://www.wa.or.kr/board/list.asp?BoardID=0006">
            <img className='w-[67px]' src="https://m.shinsegaepoint.com/img/wa_mark.144ed89e.png" alt="(사)한국장애인단체총연합회 한국웹접근성인증평가원 웹 접근성 우수사이트 인증마크 (WA인증마크)" />
          </a>
        </div>
      </div>
    </footer>
